...
capture.output(round(RBtable,3), file = 'srs_r.txt')


library("xtable")
RBtable = as.data.frame(RBtable)
Latex = xtable(RBtable, digits = c(0,c(rep(2,12))), caption = 'Estimates under srs with low R^2')
Latex
